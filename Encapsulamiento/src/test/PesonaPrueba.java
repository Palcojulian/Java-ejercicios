...
//        System.out.println("Esta eliminado: " + obPersona1.isEliminado()); 
        ...
        boolean _eliminado = consola.nextBoolean();
        
        if (_eliminado == true) {
            System.out.println("Dame la mano y vamos a darle la vuelta al mundo");
        }else {
            System.out.println("F ella no te quiere hermano");
        }
